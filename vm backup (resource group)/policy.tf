...
resource "azurerm_resource_group_policy_assignment" "vm-backup-policy-assignment" {
...
resource "azurerm_resource_group_policy_remediation" "vm-backup-policy-remediation" {
  name                 = "backup-vm-to-recovery-services-vault-remediation"
  resource_group_id    = data.azurerm_resource_group.rg.id
  policy_assignment_id = azurerm_resource_group_policy_assignment.vm-backup-policy-assignment.id
  #location_filters     = [azurerm_resource_group_policy_assignment.vm-backup-policy-assignment.location]
}
